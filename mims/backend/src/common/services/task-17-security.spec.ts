 ...
 */
describe('Task 17: Security Implementation', () => {
  ...
  describe('3. Audit Logging Structure', () => {
    /**
    ...
    it('should extract entity type from URL paths', () => {
      const testCases = [
        { path: '/api/v1/shifts', expected: 'Shifts' },
        { path: '/api/v1/leave-requests', expected: 'LeaveRequests' },
        { path: '/api/v1/attendance-records', expected: 'AttendanceRecords' },
        { path: '/api/v1/biometric-devices', expected: 'BiometricDevices' },
      ];
