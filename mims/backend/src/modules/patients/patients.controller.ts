...
export class PatientsController {
  ...
  @Post()
  @Roles('SUPER_ADMIN', 'HOSPITAL_ADMIN', 'REGISTRATION_STAFF', 'REGISTRATION_STAFF_MANAGER', 'RECEPTIONIST', 'DOCTOR', 'MAIN_PHARMACY_MANAGER', 'SUB_PHARMACY_MANAGER')
  ...
  @Get()
  @Roles('SUPER_ADMIN', 'HOSPITAL_ADMIN', 'REGISTRATION_STAFF', 'REGISTRATION_STAFF_MANAGER', 'RECEPTIONIST', 'DOCTOR', 'DOCTOR_ASSISTANT', 'MAIN_PHARMACY_MANAGER', 'SUB_PHARMACY_MANAGER', 'PHARMACY_STAFF')
  ...
  @Get('stats')
  @Roles('SUPER_ADMIN', 'HOSPITAL_ADMIN', 'REGISTRATION_STAFF', 'REGISTRATION_STAFF_MANAGER', 'RECEPTIONIST')
  ...
  @Patch(':id')
  @Roles('SUPER_ADMIN', 'HOSPITAL_ADMIN', 'REGISTRATION_STAFF', 'REGISTRATION_STAFF_MANAGER', 'RECEPTIONIST', 'DOCTOR')
  update(
    @Param('id') id: string,
